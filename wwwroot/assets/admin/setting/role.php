			...
			return {
				...
				read : function() {
					$(this.grid).dataGrid({
						...
						colModel : [
							{display:'ID', name:'mr.role_id', width:30, align:'center', css:'num'},
							{display:'角色名称', name:'mr.role_name', width:100, align:'left'},
							{display:'角色简介', width:260, align:'left'},
							{display:'添加时间', width:120, align:'center', css:'num'},
							{display:'修改时间', name:'mr.release_date', width:120, align:'center', css:'num'}
						],
						useSelect : true
