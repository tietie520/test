 ...
 *
 * Usage:
 *       $xml = Array2XML::createXML($php_array, 'root_node_name');
 *       echo $xml->saveXML();
 */
...
class Array2XML {
     ...
     * @return DomDocument
     */
    public static function createXML($arr = array(), $nodeName = 'data') {
        $xml = self::getXMLRoot();
    ...
    /**
     * Convert an Array to XML
     * @param $nodeName - name of the root node to be converted
     * @param array $arr - aray to be converterd
     * @return mixed
     * @throws Exception
     */
