...
use App\Service\PHPZip;
error_reporting( E_ALL&~E_NOTICE );

class PHPZipImpl implements PHPZip
{
    ...
    /**
     * 压缩到服务器
     * @param $dir 需压缩的文件所在目录
     * @param $saveName ZIP压缩文件名
     */
    ...
    //解压部分
    /**
     * @param $zip $zip是经过@fopen($zipfile, 'rb')打开的
